This README file contains information on the contents of the meta-rauc-rz layer.
...
Please submit any patches against the meta-rauc-rz layer via GitHub
...
I. Adding the meta-rauc-rz layer to your build
=======================================================

Run 'bitbake-layers add-layer meta-rauc-rz'
...
Add configuration required for meta-rauc-rz to your local.conf::

   # Settings for meta-rauc-rz
   IMAGE_INSTALL:append = " rauc"
   IMAGE_FSTYPES:append = " ext4"
   WKS_FILE = ""
      WKS_FILE = """rzv2h-sdcard-rauc.wks.in"
q
...
You can either flash using bmaptool (recommended)::
  ...
  $ bmaptool copy /path/to/core-image-minimal-rzv2h-evk.wic.bz2 /dev/sdX
